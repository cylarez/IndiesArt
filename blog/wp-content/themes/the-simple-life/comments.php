...
<?php else : // If there are no comments yet ?>
	<p><?php _e('No comments yet. Be the first!'); ?></p>
<?php endif; ?>
...
<p>
	...
	<p>
	 <label for="author"><?php _e('Name'); ?> <?php if ($req) _e('(required)'); ?></label> 
	  <input type="text" name="author" id="author" class="textarea" value="<?php echo $comment_author; ?>" size="28" tabindex="2" />
	...
	<p>
	  ...
	  <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="28" tabindex="4" />
	</p>
	<p>
